...
function DockLabel({ children, className = '', ...rest }: { children: ReactNode; className?: string; isHovered?: ReturnType<typeof useMotionValue<number>>; [key: string]: any }) {
...
function DockIcon({ children, className = '' }: { children: ReactNode; className?: string; [key: string]: any }) {
